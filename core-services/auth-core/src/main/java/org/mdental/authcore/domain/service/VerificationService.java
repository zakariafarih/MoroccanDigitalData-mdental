...
import org.mdental.authcore.persistence.repository.VerificationTokenRepository;
...
/**
 * Service for handling verification tokens (email verification and password reset).
 */
@Service
