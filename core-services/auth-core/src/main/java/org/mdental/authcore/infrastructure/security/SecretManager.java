...
public class SecretManager {
     ...
     * Constructor.
     *
     * @param configuredKey the configured encryption key (optional)
     * @param encryptSecrets whether to encrypt secrets
     */
    ...
    public String encryptSecret(String plaintext) {
        if (!encryptSecrets || plaintext == null) {
            return plaintext;
        }
    ...
    public String decryptSecret(String encryptedBase64) {
        if (!encryptSecrets || encryptedBase64 == null) {
